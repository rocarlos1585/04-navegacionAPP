...
export const StackNavigator = () => {
  return (
    <Stack.Navigator
      //initialRouteName='Pagina2Screen' //esta propiedad sirve para definir cual es la pantalla principal de la aplicacion
      

      screenOptions={{

        //headerShown:false,//esta propiedad quita el header donde aparece el titulo del card que se esta viendo actualmente
        headerStyle:{
          elevation:0, //propiedad para quitar la sombra debajo del header en android
